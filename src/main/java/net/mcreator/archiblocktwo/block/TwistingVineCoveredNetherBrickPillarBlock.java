...
public class TwistingVineCoveredNetherBrickPillarBlock extends Block {

	public static final EnumProperty<Direction.Axis> AXIS = BlockStateProperties.AXIS;

	public TwistingVineCoveredNetherBrickPillarBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE).sound(SoundType.NETHER_BRICKS).strength(2f, 6f));

		this.registerDefaultState(this.stateDefinition.any().setValue(AXIS, Direction.Axis.Y));

		setRegistryName("twisting_vine_covered_nether_brick_pillar");
	}
