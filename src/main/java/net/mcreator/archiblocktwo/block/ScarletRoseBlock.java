...
public class ScarletRoseBlock extends FlowerBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(ArchiblockTwoModBlocks.SCARLET_ROSE, renderType -> renderType == RenderType.cutout());
	}
